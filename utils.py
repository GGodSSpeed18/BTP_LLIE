...
# new feature map extractor
class FeatureExtractor(torch.nn.Module):
    """VGG16-based feature extractor for perceptual losses"""
    def __init__(self, device='cuda'):
        super().__init__()
        #load fixed number of layers,
        # use features [:Q]
        # Q=9 for shallow features
        # Q=16 for medium depth features
        # Q=23 for deeper features
